...
class Credentails extends StatefulWidget{
  @override
  State<Credentails> createState() => _CredentailsState();
}

class _CredentailsState extends State<Credentails> {
          ...
          SizedBox(
            ...
            child: Column(
              ...
              children: [
                SizedBox(
                  height: AppConstants.screenHeight(context)/30,
                  child: AutoSizeText('Confirm Password',
                    style: AppTextStyles.regular,
                    maxFontSize: 16,
                    minFontSize: 12,
                  ),
